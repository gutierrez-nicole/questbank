...
<div class="row g-3 mb-4">
    @foreach ([['Students', $totalStudents], ['Instructors', $totalInstructors], ['Subjects', $totalSubjects], ['Examinations', $totalExaminations], ['Registered Accounts', $totalAccounts]] as [$label, $value])
        <div class="col-md">
            <div class="card stat-card"><div class="card-body"><div class="text-muted">{{ $label }}</div><div class="display-6 fw-semibold">{{ $value }}</div></div></div>
        </div>
    @endforeach
</div>
